...
pretrained = 'pretrained_models/swin_transformer/swin_large_patch4_window12_384_22k.pth'  # noqa
...
# learning policy
# max_iters = 737500 // 10
# param_scheduler = dict(end=max_iters, milestones=[655556 // 10, 710184 // 10])
#
